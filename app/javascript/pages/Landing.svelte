<script>
    import Peelable from "../components/Peelable.svelte";
    import Background from "../components/Background.svelte";
    import Logo from "../assets/images/hackClubLogo.png";
...
<div class="page-wrapper">
    ...
    <div class="content-container">
        ...
        <Peelable
            ...
            peelOnClick={true}
            peelAwayDuration={1000}
            onPeelComplete={() => (window.location.href = "/stickers")}
            borderRadius="0.5rem"
        >
            {#snippet topContent()}
    ...
    <div class="bottom-footers">
        <footer class="open-source-footer">
            <a
                ...
                >open source, drop us a <h3 style="display:inline">star</h3></a
            >
        </footer>
    </div>
</div>
